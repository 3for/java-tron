...
public class BuildTransactionTest extends BaseTest {
  ...
  @Test
  public void testTransferWithoutValueIsRejected() {
    BuildArguments buildArguments = new BuildArguments();
    buildArguments.setFrom("0xabd4b9367799eaa3197fecb144eb71de1e049abc");
    buildArguments.setTo("0x548794500882809695a8a687866e76d4271a1abc");

    JsonRpcInvalidRequestException error = Assert.assertThrows(JsonRpcInvalidRequestException.class,
        () -> buildArguments.getContractType(wallet));
    Assert.assertEquals("invalid json request", error.getMessage());
  }
}
